...
internal static class WorkerEmitter
{
    public static string EmitSource(List<WorkerInvocationModel> workers)
    {
        ...
        sb.AppendLine("        public int ConsecutiveFailures { get; set; }");
        sb.AppendLine("    }");
        sb.AppendLine();
        ...
        sb.AppendLine("        () =>");
        sb.AppendLine("        {");
        sb.AppendLine("            var measurements = new System.Collections.Generic.List<Measurement<int>>();");
        ...
        sb.AppendLine("                };");
        sb.AppendLine("                measurements.Add(new Measurement<int>(state.IsActive ? 1 : 0, tags));");
        sb.AppendLine("            }");
        sb.AppendLine("            return measurements;");
        sb.AppendLine("        },");
        ...
        sb.AppendLine("        () =>");
        sb.AppendLine("        {");
        sb.AppendLine("            var measurements = new System.Collections.Generic.List<Measurement<long>>();");
        sb.AppendLine("            foreach (var state in _workerStates.Values)");
        sb.AppendLine("            {");
        ...
        sb.AppendLine("                        { \"worker.type\", state.WorkerType }");
        sb.AppendLine("                    };");
        sb.AppendLine("                    measurements.Add(new Measurement<long>(state.LastSuccessTimestamp, tags));");
        sb.AppendLine("                }");
        sb.AppendLine("            }");
        sb.AppendLine("            return measurements;");
        sb.AppendLine("        },");
        ...
        sb.AppendLine("    /// </summary>");
        sb.AppendLine("    internal static readonly ObservableGauge<int> ConsecutiveFailuresGauge = Meter.CreateObservableGauge<int>(");
        ...
        sb.AppendLine("                    { \"worker.type\", state.WorkerType }");
        sb.AppendLine("                };");
        sb.AppendLine("                measurements.Add(new Measurement<int>(state.ConsecutiveFailures, tags));");
        sb.AppendLine("            }");
        sb.AppendLine("            return measurements;");
        sb.AppendLine("        },");
